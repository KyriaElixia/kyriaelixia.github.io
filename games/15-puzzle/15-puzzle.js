...
createGame = function() {
    ...
    backgroundStyle.value = "position: absolute; left:"+xZero+"; top:"+yZero+"; width:"+gameSize*size+"; height:"+gameSize*size+"; background-image: url('https://kyriaelixia.github.io/games/minesweeper/sprites/light_mode/tiles/open-tile.png'); background-size: "+size+"px "+size+"px;";
    ...
    for (y = 0; y < gameSize; y++) {
        ...
        for (x = 0; x < gameSize; x++) {
            ...
            tileImgSrc.value = "https://kyriaelixia.github.io/games/minesweeper/sprites/light_mode/tiles/tile.png";
...
createBorder = function() {
        ...
        for (b = 0; b < lim; b++) {
            ...
            if (b == 0) {
                ...
                if (t == 0) {
                    ...
                    // borderImgSrc.value = "https://kyriaelixia.github.io/games/minesweeper/sprites/light_mode/frame/cross-nes.png";
                    borderImgSrc.value = "https://kyriaelixia.github.io/games/minesweeper/sprites/light_mode/frame/corner-es.png";
                }
                else {
                    
                    borderImgSrc.value = "https://kyriaelixia.github.io/games/minesweeper/sprites/light_mode/frame/corner-ne.png";
                }
            }
            else if (b == lim-1) {
                ...
                if (t == 0) {
                    ...
                    // borderImgSrc.value = "https://kyriaelixia.github.io/games/minesweeper/sprites/light_mode/frame/cross-nsw.png";
                    borderImgSrc.value = "https://kyriaelixia.github.io/games/minesweeper/sprites/light_mode/frame/corner-sw.png";
                }
                else {

                    borderImgSrc.value = "https://kyriaelixia.github.io/games/minesweeper/sprites/light_mode/frame/corner-nw.png";
                }
            }
            else {

                borderImgSrc.value = "https://kyriaelixia.github.io/games/minesweeper/sprites/light_mode/frame/line-h.png";
            }
    ...
    for (t = 0; t < 2; t++) {
        for (b = 1; b < lim-1; b++) {
            ...
            borderImgSrc = document.createAttribute("Src");
            borderImgSrc.value = "https://kyriaelixia.github.io/games/minesweeper/sprites/light_mode/frame/line-v.png";
            borderImg.setAttributeNode(borderImgSrc);
...
timer = function() {
    ...
    document.getElementById("clock_100").src = "https://kyriaelixia.github.io/games/minesweeper/sprites/light_mode/digits/"+hundra+"-digit.png"; 
    document.getElementById("clock_10").src = "https://kyriaelixia.github.io/games/minesweeper/sprites/light_mode/digits/"+tio+"-digit.png";
    document.getElementById("clock_1").src = "https://kyriaelixia.github.io/games/minesweeper/sprites/light_mode/digits/"+ett+"-digit.png";
}
...
moveCounter = function() {
    ...
    document.getElementById("moves_100").src = "https://kyriaelixia.github.io/games/minesweeper/sprites/light_mode/digits/"+hundra+"-digit.png"; 
    document.getElementById("moves_10").src = "https://kyriaelixia.github.io/games/minesweeper/sprites/light_mode/digits/"+tio+"-digit.png";
    document.getElementById("moves_1").src = "https://kyriaelixia.github.io/games/minesweeper/sprites/light_mode/digits/"+ett+"-digit.png";
}
...
toggleOption = function(option) {
    ...
    if (option == "settings") {
        ...
        if (settings == false) {
            ...
            // document.getElementById("toggleSettings").src = "https://kyriaelixia.github.io/games/minesweeper/sprites/light_mode/buttons/settings.png";
            settings = false;
        }
    }
