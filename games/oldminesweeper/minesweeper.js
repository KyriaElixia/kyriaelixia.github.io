    ...
    for (y = 0; y < height; y++) {
        for (x = 0; x < width; x++) {
            ...
            if (field[x][y] == "hidden") {
                ...
                game.picture(x * size, y * size, "https://kyriaelixia.github.io/games/oldminesweeper/sprites/tile.png", size, size);
            }
            else if (field[x][y] == 0) {

                game.picture(x * size, y * size, "https://kyriaelixia.github.io/games/oldminesweeper/sprites/open-tile.png", size, size);
            }
            else if (field[x][y] >= 1 && field[x][y] <= 8) {

                game.picture(x * size, y * size, "https://kyriaelixia.github.io/games/oldminesweeper/sprites/" + field[x][y] + "-tile.png", size, size);
            }
            else if (field[x][y] == "flag") {

                game.picture(x * size, y * size, "https://kyriaelixia.github.io/games/oldminesweeper/sprites/flag.png", size, size);
            }
            else if (field[x][y] == "bomb") {

                game.picture(x * size, y * size, "https://kyriaelixia.github.io/games/oldminesweeper/sprites/bomb.png", size, size);
            }
            else if (field[x][y] == "exploded" || field[x][y] == "not") {

                game.picture(x * size, y * size, "https://kyriaelixia.github.io/games/oldminesweeper/sprites/" + field[x][y] + "-bomb.png", size, size);
            }
            else if (field[x][y] == "maybe") {

                game.picture(x * size, y * size, "https://kyriaelixia.github.io/games/oldminesweeper/sprites/maybe.png", size, size);
            }
            ...
            if (document.getElementById("extraSettings").showErrors.checked == true) {
                ...
                if (field[x][y] >= 1 && field[x][y] <= 8) {
                    ...
                    if (tileCount > field[x][y]) {
                        ...
                        game.picture(x * size, y * size, "https://kyriaelixia.github.io/games/oldminesweeper/sprites/error-" + field[x][y] + ".png", size, size);
                    }
                }
            }
        }
